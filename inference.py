...
class TagPytorchInference(object):
    ...
    def _load(self, **kwargs):
        ...
        _model_name = os.path.join(current_folder, 'model', 'best_model.pth')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-image', "--image", type=str,
                        help='Assign the image path.', default=None)
    ...
    for i in range(5):
        print('{0}: {1}%'.format(
            CLASSES[top5[-i-1]], str(result[0][top5[-i - 1]] * 100)))
    print('done!')
